...
internal class AdvisorImageResultAdapter(private val onItemSelectChange: OnItemSelectChange) :
    RecyclerView.Adapter<AdvisorImageResultAdapter.ImageViewHolder>() {
